...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('meta_contact_identities')) {
        ...
        } elseif (! Schema::hasIndex('meta_contact_identities', 'mci_conn_channel_ext_user_unique')) {
            Schema::table('meta_contact_identities', function (Blueprint $table): void {
                $table->unique(
                    ['meta_connection_id', 'channel', 'external_user_id'],
                    'mci_conn_channel_ext_user_unique'
                );
        ...
        if (! Schema::hasTable('meta_conversations')) {
        ...
        if (! Schema::hasTable('meta_messages')) {
        ...
        if (! Schema::hasTable('meta_message_templates')) {
        ...
        } elseif (! Schema::hasIndex('meta_message_templates', 'mmt_conn_name_lang_unique')) {
            Schema::table('meta_message_templates', function (Blueprint $table): void {
                $table->unique(
                    ['meta_connection_id', 'template_name', 'language'],
                    'mmt_conn_name_lang_unique'
                );
        ...
        if (! Schema::hasTable('meta_automation_flows')) {
        ...
        if (! Schema::hasTable('meta_automation_steps')) {
        ...
        if (! Schema::hasTable('meta_automation_sessions')) {
        ...
        if (! Schema::hasTable('meta_broadcasts')) {
        ...
        if (! Schema::hasTable('meta_broadcast_recipients')) {
