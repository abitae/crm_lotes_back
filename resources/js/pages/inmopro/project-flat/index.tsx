...
import { Eye, Map, MapPin, Search, Settings2 } from 'lucide-react';
...
export default function ProjectFlatIndex({
    projects,
    filters,
    canManage,
}: PageProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Vista plana - Inmopro" />
            <div className="space-y-6 p-4 md:p-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Mapa en vivo de cada proyecto y polígonos ligados a sus
                        lotes.
                    </p>
                </div>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="rounded-lg bg-slate-50 px-3 py-2 text-sm text-slate-600">
                                        <strong className="text-slate-900">
                                            {project.polygons_count}
                                        </strong>{' '}
                                        polígono(s) dibujado(s)
                                    </div>

                                    <Button asChild className="w-full">
                                        <Link
                                            href={projectFlat.show(project.id)}
                                            prefetch
                                        >
                                            {canManage ? (
