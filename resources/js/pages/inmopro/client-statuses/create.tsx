...
export default function ClientStatusesCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Nuevo', href: '/inmopro/client-statuses/create' },
    ];

    const submit = (e: FormEvent) => {
        e.preventDefault();
        post('/inmopro/client-statuses');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Nuevo Estado CRM - Inmopro" />
            <div className="p-4">
                <h2 className="mb-6 text-2xl font-black text-slate-800">Nuevo estado CRM</h2>
