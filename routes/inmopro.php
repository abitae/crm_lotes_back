...
use App\Http\Controllers\Inmopro\Project360FloorPlanController;
...
Route::middleware(['auth', 'verified'])->prefix('inmopro')->name('inmopro.')->group(function (): void {
    ...
    Route::middleware(['inmopro.permission'])->group(function (): void {
        ...
        Route::prefix('project-360')->name('project-360.')->group(function (): void {
            ...
            Route::post('{project}/floor-plans', [Project360FloorPlanController::class, 'store'])->name('floor-plans.store');
            Route::patch('{project}/floor-plans/{floorPlan}', [Project360FloorPlanController::class, 'update'])->name('floor-plans.update');
            Route::delete('{project}/floor-plans/{floorPlan}', [Project360FloorPlanController::class, 'destroy'])->name('floor-plans.destroy');
            Route::put('{project}/settings', [Project360SettingsController::class, 'tour'])->name('settings.update');
            Route::put('{project}/scene-settings', [Project360SettingsController::class, 'scene'])->name('scene-settings.update');
